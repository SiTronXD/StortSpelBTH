...
function script:update(dt)
	...
	if paused then
		...
		uiRenderer.renderTexture(vector(resumePosX, resumePosY), vector(resumeWidth, resumeHeight))
		uiRenderer.renderTexture(vector(exitPosX, exitPosY), vector(exitWidth, exitHeight))
