...
void GameScene::start()
{
    ...
    this->setComponent<Collider>(
        this->perk, Collider::createSphere(2.f, glm::vec3(0), true)
    );
    ...
    this->setComponent<Collider>(
        this->perk1, Collider::createSphere(2.f, glm::vec3(0), true)
    );
    ...
    this->setComponent<Collider>(
        this->perk2, Collider::createSphere(2.f, glm::vec3(0), true)
    );
...
void GameScene::createPortal()
{
    ...
    this->setComponent<Collider>(
        portal, Collider::createBox(portalTriggerDims, glm::vec3(0), true)
    );
