...
/*
	SET INACTIVE ENTITIES ON SERVER (ALL INACTIVE WHEN ROAMING, ONLY ACTIVE DURING FIGHT)
	SET INACTIVE ENTITIES ON SERVER (ALL INACTIVE WHEN ROAMING, ONLY ACTIVE DURING FIGHT)
	SET INACTIVE ENTITIES ON SERVER (ALL INACTIVE WHEN ROAMING, ONLY ACTIVE DURING FIGHT)
 
	REMOVE UNUSED ENTITIES FROM SERVER
	REMOVE UNUSED ENTITIES FROM SERVER
	REMOVE UNUSED ENTITIES FROM SERVER

	REMOVE INVALID ENTITIES FROM AUDIOHANDLER
	REMOVE INVALID ENTITIES FROM AUDIOHANDLER
	REMOVE INVALID ENTITIES FROM AUDIOHANDLER
*/
