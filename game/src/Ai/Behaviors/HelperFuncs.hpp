...
void        avoidStuff(Entity entityID, SceneHandler* sceneHandler, bool& attackGoRight, glm::vec3 target, glm::vec3& wantedDir, glm::vec3 rayOriginOffset = glm::vec3(0.0f, 0.0f, 0.0f), bool drawRays = true);
